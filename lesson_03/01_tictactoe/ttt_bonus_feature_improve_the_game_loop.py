# rules:
    # explicit: choose_square invokes computer_chooses_square or player_chooses_square depending on the value of current_player
    # implicit: alternate_player switches player
# algorithms:
    # alternate_player(current_player)
        # If current_player is 'player', reassign w/ 'computer'
        # Else reassign w/ 'player'
        # Return current_player
    # choose_square(board, current_player)
        # Will invoke player_chooses_square with board as arg if current_player is 'player'
        # Else will invoke computer_chooses_square with board as arg
...
# added alternate_player and choose_square functions
